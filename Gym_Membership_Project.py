# -*- coding: utf-8 -*-
"""
Created on Mon Nov  8 19:09:15 2021
...
while True:
    x = input("***********Welcome to Gym Management***********\nPress 1 for SUPER-USER: \nPress 2 for Member: \nEnter your option:")
    choose_option = 100
    if x == "1":
        ...
        while choose_option != "0":
            ...
            if choose_option == "1":
                Member.Add_Member()
                print('Member Created Succesfully')
                ...
                if Input3 in Regimen_for_All_Member:
                    ...
                    for i in range(1, (Input4 + 1)):
                        ...
                        print('Regimen Updated Succesfully')
                else:
